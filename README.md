...
<head>
    ...
    <title>Training Tracker v5</title>
    ...
    <style>
        ...
        .input-group button { background: #444; width: 35px; height: 35px; padding: 0; font-size: 1.2rem; border-radius: 5px; color: white; border: none; cursor: pointer; }
...
<script>
    ...
    function changeVal(id, delta) {
        ...
        input.value = val;
        // Smart-Fill: Wenn kg in Satz 1 geändert wird, fülle Satz 2 und 3
    ...
    function openStats(ex) {
        ...
        weightChart = new Chart(document.getElementById('weightChart'), { type: 'line', data: { labels, datasets: [{ label: 'Ø kg', data: avgWeights, borderColor: '#00adb5' }] }, options: { color: 'white' } });
    ...
    function startTimer(seconds) {
        ...
        timerInterval = setInterval(() => {
            ...
            if (timeLeft === 0) { clearInterval(timerInterval); display.innerText = "GO!"; beep(900, 1000, 0.5); }
            timeLeft--;
        }, 1000);
    }
